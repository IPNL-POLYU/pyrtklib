...
extern void deg2dms (double deg,Arr1D<double> Sdms){
    double *dms = Sdms.src;
    deg2dms(deg, dms);
...
extern void strsendnmea(stream_t *stream,Arr1D<double> Spos){
    const double *pos = Spos.src;
    strsendnmea(stream, pos);
...
extern int pppamb(rtk_t *rtk, const obsd_t *obs, int n, const nav_t *nav,Arr1D<double> Sazel){
    const double *azel = Sazel.src;
...
extern int  strsvrstart(strsvr_t *svr,Arr1D<int> Sopts,Arr1D<int> Sstrs,std::vector<std::string> Dpaths,std::vector<std::vector<strconv_t>> Dconv, const char *cmd,Arr1D<double> Snmeapos){
    char **paths = convertChar(Dpaths);
    strconv_t **conv = convertType(Dconv);
    int *opts = Sopts.src;
    int *strs = Sstrs.src;
    const double *nmeapos = Snmeapos.src;
    auto tmp = strsvrstart(svr, opts, strs, paths, conv, cmd, nmeapos);
    free(paths);
    free(conv);
    return tmp;
}
...
extern int  rtksvrstart (rtksvr_t *svr, int cycle, int buffsize,Arr1D<int> Sstrs,std::vector<std::string> Dpaths,Arr1D<int> Sformats, int navsel,std::vector<std::string> Dcmds,std::vector<std::string> Drcvopts, int nmeacycle, int nmeareq,Arr1D<double> Snmeapos, prcopt_t *prcopt, solopt_t *solopt, stream_t *moni){
    char **paths = convertChar(Dpaths);
    ...
    const double *nmeapos = Snmeapos.src;
    auto tmp = rtksvrstart(svr, cycle, buffsize, strs, paths, formats, navsel, cmds, rcvopts, nmeacycle, nmeareq, nmeapos, prcopt, solopt, moni);
    free(paths);
    free(cmds);
    free(rcvopts);
    return tmp;
...
PYBIND11_MODULE(pyrtklib, m) {
    ...
    m.attr("NSATLEO")=0;
    m.attr("NSYSLEO")=0;
    m.attr("NSYS")=(NSYSGPS+NSYSGLO+NSYSGAL+NSYSQZS+NSYSCMP+NSYSLEO);
    m.attr("MINPRNSBS")=120;
    m.attr("MAXPRNSBS")=142;
    m.attr("NSATSBS")=(MAXPRNSBS-MINPRNSBS+1);
    m.attr("MAXSAT")=(NSATGPS+NSATGLO+NSATGAL+NSATQZS+NSATCMP+NSATSBS+NSATLEO);
    m.attr("MAXOBS")=64;
    m.attr("MAXRCV")=64;
    ...
    m.attr("MAXSTRRTK")=8;
    m.attr("MAXSBSMSG")=32;
    m.attr("MAXSOLMSG")=4096;
    m.attr("MAXRAWLEN")=8192;
    ...
    m.attr("TROPOPT_COR")=5;
    m.attr("TROPOPT_CORG")=6;
    ...
    m.attr("ARMODE_PPPAR")=4;
    m.attr("ARMODE_PPPAR_ILS")=5;
    m.attr("ARMODE_WLNL")=6;
    m.attr("ARMODE_TCAR")=7;
    ...
    m.attr("STRFMT_LEXR")=13;
    m.attr("STRFMT_SEPT")=14;
    ...
    py::class_<stecd_t>(m,"stecd_t").def(py::init())
        .def_readwrite("time",&stecd_t::time)
        .def_readwrite("sat",&stecd_t::sat)
        .def_readwrite("slip",&stecd_t::slip)
        .def_readwrite("iono",&stecd_t::iono)
        .def_readwrite("rate",&stecd_t::rate)
        .def_readwrite("rms",&stecd_t::rms)
        .def_property_readonly("ptr",[](stecd_t& o){return &o;},py::return_value_policy::reference);
    ...
    py::class_<stec_t>(m,"stec_t").def(py::init())
        ...
        .def_property("data",[](stec_t& o) {Arr1D<stecd_t>* tmp = new Arr1D<stecd_t>(o.data,-1);return tmp;},[](stec_t& o,Arr1D<stecd_t>arr){o.data=arr.src;},py::return_value_policy::reference)
        .def_property_readonly("ptr",[](stec_t& o){return &o;},py::return_value_policy::reference);

    py::class_<zwdd_t>(m,"zwdd_t").def(py::init())
        .def_readwrite("time",&zwdd_t::time)
        .def_readwrite("zwd",&zwdd_t::zwd)
        .def_readwrite("rms",&zwdd_t::rms)
        .def_property_readonly("ptr",[](zwdd_t& o){return &o;},py::return_value_policy::reference);
    ...
    py::class_<zwd_t>(m,"zwd_t").def(py::init())
        ...
        .def_property("data",[](zwd_t& o) {Arr1D<zwdd_t>* tmp = new Arr1D<zwdd_t>(o.data,-1);return tmp;},[](zwd_t& o,Arr1D<zwdd_t>arr){o.data=arr.src;},py::return_value_policy::reference)
    ...
    py::class_<sbsigpband_t>(m,"sbsigpband_t").def(py::init())
        ...
        .def_property("y",[](sbsigpband_t& o) {Arr1D<short>* tmp = new Arr1D<short>(const_cast<short*>(o.y),-1);return tmp;},[](sbsigpband_t& o,Arr1D<short>arr){o.y=arr.src;},py::return_value_policy::reference)
    ...
    py::class_<ssr_t>(m,"ssr_t").def(py::init())
        ...
        .def_property_readonly("t0",[](ssr_t& o) {Arr1D<gtime_t>* tmp = new Arr1D<gtime_t>(o.t0,5);return tmp;},py::return_value_policy::reference)
        .def_property_readonly("udi",[](ssr_t& o) {Arr1D<double>* tmp = new Arr1D<double>(o.udi,5);return tmp;},py::return_value_policy::reference)
        .def_property_readonly("iod",[](ssr_t& o) {Arr1D<int>* tmp = new Arr1D<int>(o.iod,5);return tmp;},py::return_value_policy::reference)
    ...
    py::class_<lex_t>(m,"lex_t").def(py::init())
        ...
        .def_property("msgs",[](lex_t& o) {Arr1D<lexmsg_t>* tmp = new Arr1D<lexmsg_t>(o.msgs,-1);return tmp;},[](lex_t& o,Arr1D<lexmsg_t>arr){o.msgs=arr.src;},py::return_value_policy::reference)
    ...
    py::class_<nav_t>(m,"nav_t").def(py::init())
        ...
        .def_property("stec",[](nav_t& o) {Arr1D<stec_t>* tmp = new Arr1D<stec_t>(o.stec,-1);return tmp;},[](nav_t& o,Arr1D<stec_t>arr){o.stec=arr.src;},py::return_value_policy::reference)
    ...
    py::class_<rtcm_t>(m,"rtcm_t").def(py::init())
        ...
        .def_property_readonly("nmsg3",[](rtcm_t& o) {Arr1D<unsigned int>* tmp = new Arr1D<unsigned int>(o.nmsg3,300);return tmp;},py::return_value_policy::reference)
    ...
    py::class_<rnxctr_t>(m,"rnxctr_t").def(py::init())
        ...
        .def_property_readonly("tobs",[](rnxctr_t& o) {Arr2D<char>* tmp = new Arr2D<char>(o.tobs,6,MAXOBSTYPE);return tmp;},py::return_value_policy::reference)
    ...
    py::class_<opt_t>(m,"opt_t").def(py::init())
        ...
        .def_property("name",[](opt_t& o) {Arr1D<char>* tmp = new Arr1D<char>(o.name,-1);return tmp;},[](opt_t& o,Arr1D<char>arr){o.name=arr.src;},py::return_value_policy::reference)
        ...
        .def_property("comment",[](opt_t& o) {Arr1D<char>* tmp = new Arr1D<char>(o.comment,-1);return tmp;},[](opt_t& o,Arr1D<char>arr){o.comment=arr.src;},py::return_value_policy::reference)
    ...
    py::class_<prcopt_t>(m,"prcopt_t").def(py::init())
        ...
        .def_property_readonly("prn",[](prcopt_t& o) {Arr1D<double>* tmp = new Arr1D<double>(o.prn,5);return tmp;},py::return_value_policy::reference)
        .def_property_readonly("thresar",[](prcopt_t& o) {Arr1D<double>* tmp = new Arr1D<double>(o.thresar,4);return tmp;},py::return_value_policy::reference)
    ...
    py::class_<rnxopt_t>(m,"rnxopt_t").def(py::init())
        ...
        .def_property_readonly("mask",[](rnxopt_t& o) {Arr2D<char>* tmp = new Arr2D<char>(o.mask,6,64);return tmp;},py::return_value_policy::reference)
        ...
        .def_property_readonly("tobs",[](rnxopt_t& o) {Arr2D<char>* tmp = new Arr2D<char>(o.tobs,6,MAXOBSTYPE);return tmp;},py::return_value_policy::reference)
        .def_property_readonly("nobs",[](rnxopt_t& o) {Arr1D<int>* tmp = new Arr1D<int>(o.nobs,6);return tmp;},py::return_value_policy::reference)
    ...
    py::class_<ssat_t>(m,"ssat_t").def(py::init())
        ...
        .def_property_readonly("lock",[](ssat_t& o) {Arr1D<unsigned int>* tmp = new Arr1D<unsigned int>(o.lock,NFREQ);return tmp;},py::return_value_policy::reference)
    ...
    py::class_<ambc_t>(m,"ambc_t").def(py::init())
        ...
        .def_property_readonly("n",[](ambc_t& o) {Arr1D<double>* tmp = new Arr1D<double>(o.n,4);return tmp;},py::return_value_policy::reference)
    ...
    py::class_<raw_t>(m,"raw_t").def(py::init())
        ...
        .def_readwrite("receive_time",&raw_t::receive_time)
        .def_readwrite("plen",&raw_t::plen)
        .def_readwrite("pbyte",&raw_t::pbyte)
        .def_readwrite("page",&raw_t::page)
        .def_readwrite("reply",&raw_t::reply)
        .def_readwrite("week",&raw_t::week)
        ...
        .def_property_readonly("pbuff",[](raw_t& o) {Arr1D<unsigned char>* tmp = new Arr1D<unsigned char>(o.pbuff,255+4+2);return tmp;},py::return_value_policy::reference)
    ...
    py::class_<stream_t>(m,"stream_t").def(py::init())
        ...
        .def_readwrite("tick",&stream_t::tick)
    ...
    py::class_<strsvr_t>(m,"strsvr_t").def(py::init())
        ...
        .def_property("buff",[](strsvr_t& o) {Arr1D<char>* tmp = new Arr1D<char>(o.buff,-1);return tmp;},[](strsvr_t& o,Arr1D<unsigned char>arr){o.buff=arr.src;},py::return_value_policy::reference)
        .def_property("pbuf",[](strsvr_t& o) {Arr1D<char>* tmp = new Arr1D<char>(o.pbuf,-1);return tmp;},[](strsvr_t& o,Arr1D<unsigned char>arr){o.pbuf=arr.src;},py::return_value_policy::reference)
    ...
    m.attr("igpband1") = new Arr2D<sbsigpband_t>((void*)igpband1,-1,8);
    m.attr("igpband2") = new Arr2D<sbsigpband_t>((void*)igpband2,-1,5);
    ...
    m.def("deg2dms",static_cast<void(*)(double deg,Arr1D<double> Sdms)>(&deg2dms),"rtklib deg2dms");
    ...
    m.def("rtksvrstart",static_cast<int(*)(rtksvr_t *svr, int cycle, int buffsize,Arr1D<int> Sstrs,std::vector<std::string> Dpaths,Arr1D<int> Sformats, int navsel,std::vector<std::string> Dcmds,std::vector<std::string> Drcvopts, int nmeacycle, int nmeareq,Arr1D<double> Snmeapos, prcopt_t *prcopt, solopt_t *solopt, stream_t *moni)>(&rtksvrstart),"rtklib rtksvrstart");
    ...
    m.def("rtkpos_test_hello",&rtkpos_test_hello,"rtklib rtkpos_test_hello");
